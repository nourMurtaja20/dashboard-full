...
const OpenProjectPage = () => {
    ...
    let onclickHandller = () => {
        navigator(`/managerDashboard/openProject/ProjectDetails`);
    }
    let onclickaddprojectHandller = () => {
        navigator(`/managerDashboard/openProject/addnew`);
    }
    let onclickMyprojectHandller = () => {
        navigator(`/managerDashboard/openProject/myproject`);
        ...
        <>
            <section className='sectionopen'>
                ...
                <section class="section-filter1">
                    ...
                    <button className='btnDark' onClick={onclickMyprojectHandller}>My Project</button>
                    <button className='btnwhite' onClick={onclickaddprojectHandller}>add</button>
                </section>
            </section>
